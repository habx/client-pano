...
`,vN=({style:e="default",title:t,meta:n,projectSlug:r,...i})=>{const[o,a]=C.useState(!1),l=C.useRef();return C.useLayoutEffect(()=>{const s=u=>{l.current!==u&&a(!1)};if(o)return document.addEventListener("click",s),()=>document.removeEventListener("click",s)},[o]),Xc(pN,{...i,"data-open":o,children:[e==="default"&&Le(C.Fragment,{children:Xc(dN,{children:[!o&&Le(cN,{}),Le(sN,{}),!o&&Le(uN,{onClick:s=>{l.current=s.nativeEvent,a(!0)}}),Le(ax,{onClick:()=>a(!1),children:t}),Le(fN,{})]})}),e==="project"&&Le(hN,{color:n==null?void 0:n.color,children:Le("img",{src:`/client-pano//${r}/logo.png`,alt:"logo"})})]})},mN=C.forwardRef(({manifest:e,onReady:t,projectSlug:n,...r},i)=>{const{infoHotspots:o,sceneData:a}=e;C.useEffect(()=>{t&&t(!0)},[t]);const l=C.useMemo(()=>o==null?void 0:o.find(s=>{var u;return!!((u=s.meta)!=null&&u.projectLogo)}),[o]);return Le(aN,{autorotate:!1,...r,initialView:l,sceneData:a,ref:i,children:i4(o,"pitch").map(s=>Le(vN,{projectSlug:n,...s},`${s.pitch}-${s.yaw}`))})}),yN=Q.div`
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
...
//# sourceMappingURL=index-e1cb19ef.js.map
